...
<form method="post" action="{{route('posts.update', $post->id)}}" enctype="multipart/form-data" >
    ...
    <div class="form-group">
      ...
      <img src="{{asset('images/'.$post->image)}}" alt="" id="file-preview">
      <input type="hidden" name="input_post_image" value="{{$post->image}}">
    ...
    <div class="form-group">
      ...
      <textarea id="summary" name="summary" value="{{ $post->summary}}" >{{ $post->summary }}</textarea>
    </div>
    <div class="form-group">
      <label for="description">Description</label>
      <textarea id="description" name="description" value="{{ $post->description}}" >{{$post->description}}</textarea>
    </div>
